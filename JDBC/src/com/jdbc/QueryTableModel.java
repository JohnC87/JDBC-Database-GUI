...
//    public void refreshFromDBAudit( Statement stmt1)
//    {
//        //modelData is the data stored by the table
//        //when set query is called the data from the
//        //DB is queried using “SELECT * FROM myInfo”
...
//        try{
//            //Execute the query and store the result set and its metadata
//            rs = stmt.executeQuery("SELECT * FROM marketdata_audit;");
//            ResultSetMetaData meta = rs.getMetaData();
//       
//            //to get the number of columns
//            colCount = meta.getColumnCount();
...
//        }//end try clause
//        catch(Exception e) {
//                    System.out.println("Error with refreshFromAuditDB Method\n"+e.toString());
//        } // end catch clause to query table
//    }//end refreshFromDB method
//	
//	
...
//	public void refreshAuditTableFromDB(Statement stmt1) {
//		modelData = new Vector();
//		stmt = stmt1;
//		try {
//			rs = stmt.executeQuery("select * from records_audit;");
//			ResultSetMetaData meta = rs.getMetaData();
//			colCount = meta.getColumnCount();
//			headers = new String[colCount];
//
...
//		} catch (Exception e) {
//			System.out.println("Error with refreshAuditTableFromDB Method\n" + e.toString());
//		}
//	}
